...
PLAYERS = [
    ("player1", "Pixel art sprite of a heroic male adventurer knight, short brown hair, blue tunic with belt, brown boots, holding a small sword at side, standing facing forward with both feet on ground, gothic fantasy D&D style, 16-color palette, front view, full body filling the canvas, OPAQUE body with NO transparency and NO gaps, solid flat pure black RGB(0,0,0) background, crisp pixel art outlines, high contrast gothic lighting, NO text NO UI NO watermark"),
    ("player2", "Pixel art sprite of a heroic female adventurer warrior, long red hair, green tunic with belt, brown boots, holding a small sword at side, standing facing forward with both feet on ground, gothic fantasy D&D style, 16-color palette, front view, full body filling the canvas, OPAQUE body with NO transparency and NO gaps, solid flat pure black RGB(0,0,0) background, crisp pixel art outlines, high contrast gothic lighting, NO text NO UI NO watermark"),
    ("char_mage", "Pixel art sprite of a wizard mage character, long blue robe with stars, pointed hat, white beard, holding a wooden staff, standing facing forward with both feet on ground, gothic fantasy D&D style, 16-color palette, front view, full body filling the canvas, OPAQUE body with NO transparency and NO gaps, solid flat pure black RGB(0,0,0) background, crisp pixel art outlines, high contrast gothic lighting, NO text NO UI NO watermark"),
    ("char_orc", "Pixel art sprite of a green orc warrior, muscular green skin, tusks, loincloth, holding a crude axe, standing facing forward with both feet on ground, gothic fantasy D&D style, 16-color palette, front view, full body filling the canvas, OPAQUE body with NO transparency and NO gaps, solid flat pure black RGB(0,0,0) background, crisp pixel art outlines, high contrast gothic lighting, NO text NO UI NO watermark"),
    ("char_elf", "Pixel art sprite of an elf ranger, pointed ears, green hooded cloak, leather armor, holding a bow, standing facing forward with both feet on ground, gothic fantasy D&D style, 16-color palette, front view, full body filling the canvas, OPAQUE body with NO transparency and NO gaps, solid flat pure black RGB(0,0,0) background, crisp pixel art outlines, high contrast gothic lighting, NO text NO UI NO watermark"),
    ("char_knight", "Pixel art sprite of a holy knight paladin, full plate armor, helmet with plume, holding a longsword vertical, standing facing forward with both feet on ground, gothic fantasy D&D style, 16-color palette, front view, full body filling the canvas, OPAQUE body with NO transparency and NO gaps, solid flat pure black RGB(0,0,0) background, crisp pixel art outlines, high contrast gothic lighting, NO text NO UI NO watermark"),
    ("char_golem", "Pixel art sprite of a stone golem character, bulky body made of grey stone blocks, glowing green eyes, no legs (column-like base), standing facing forward, gothic fantasy D&D style, 16-color palette, front view, full body filling the canvas, OPAQUE body with NO transparency and NO gaps, solid flat pure black RGB(0,0,0) background, crisp pixel art outlines, high contrast gothic lighting, NO text NO UI NO watermark"),
    ("char_dragon", "Pixel art sprite of a draconian humanoid character, dragon-like head with horns and snout, red scaled body, tail, wearing leather armor, standing facing forward with both feet on ground, gothic fantasy D&D style, 16-color palette, front view, full body filling the canvas, OPAQUE body with NO transparency and NO gaps, solid flat pure black RGB(0,0,0) background, crisp pixel art outlines, high contrast gothic lighting, NO text NO UI NO watermark"),
    ("char_vampire", "Pixel art sprite of a vampire lord character, pale skin, black hair slicked back, red and black cape, formal suit, fangs visible, standing facing forward with both feet on ground, gothic fantasy D&D style, 16-color palette, front view, full body filling the canvas, OPAQUE body with NO transparency and NO gaps, solid flat pure black RGB(0,0,0) background, crisp pixel art outlines, high contrast gothic lighting, NO text NO UI NO watermark"),
]
