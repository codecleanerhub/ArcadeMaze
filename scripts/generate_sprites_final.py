...
CREATURES = [
    ...
    ("monster_002", "abyssal spider, armored black carapace, multiple red eyes, dangling webs"),
    ("monster_003", "spectral wolf, smoky gray fur, glowing green eyes, tattered collar"),
    ("monster_004", "corrupted cultist, hooded purple robe, runic tattoos, ritual dagger"),
    ("monster_005", "mimic treasure chest, mouth full of teeth, leather straps, tongue flicking"),
    ("monster_006", "giant rat, matted brown fur, rotten yellow teeth, scavenger posture"),
    ("monster_007", "swamp witch, pointed black hat, potion vials, greenish skin"),
    ...
    ("monster_011", "ash serpent, smoky gray scales, ember orange eyes, sinuous body"),
